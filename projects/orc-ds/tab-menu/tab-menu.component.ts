...
@Component({
  ...
  styles: [`.orc-tab-menu{display:block;overflow:auto}.orc-tab-menu ul{display:flex;gap:.25rem;margin:0;padding:0;border-bottom:1px solid #e2e8f0;list-style:none}.orc-tab-menu button{border:0;border-bottom:2px solid transparent;background:transparent;padding:.65rem .85rem;color:#475569}.orc-tab-menu button[aria-selected=true]{border-bottom-color:#2563eb;color:#1d4ed8;font-weight:600}.orc-tab-menu button:disabled{opacity:.5}.orc-tab-menu.scrollable ul{min-width:max-content}`],

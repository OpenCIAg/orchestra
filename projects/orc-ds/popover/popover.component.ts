...
export class PopoverComponent {
  readonly open=model(false); readonly placement=input<PopoverPlacement>('bottom'); readonly align=input<PopoverAlign>('start'); readonly label=input<string | undefined>(undefined); readonly ariaLabel=input<string | undefined>(undefined); readonly ariaLabelledBy=input<string | undefined>(undefined); readonly dismissable=input(true); readonly style=input<Record<string, string | number> | undefined>(undefined); readonly styleClass=input(''); readonly appendTo=input<unknown>(undefined); readonly autoZIndex=input(true); readonly baseZIndex=input(0); readonly focusOnShow=input(true); readonly showTransitionOptions=input('150ms cubic-bezier(0, 0, 0.2, 1)'); readonly hideTransitionOptions=input('100ms linear'); readonly ariaCloseLabel=input<string | undefined>(undefined); readonly onShow=output<void>(); readonly onHide=output<void>();

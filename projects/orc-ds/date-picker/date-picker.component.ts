...
export class DatePickerComponent implements ControlValueAccessor {
  ...
  private formatDateParts(year: number, month: number, day: number): string {
    ...
    return new Intl.DateTimeFormat(this.document.documentElement.lang || undefined, { day: '2-digit', month: '2-digit', year: 'numeric' }).format(new Date(year, month - 1, day));
  }
  ...
  private normalizeDateInput(value: string): string {
    ...
    const localeTokens = new Intl.DateTimeFormat(this.document.documentElement.lang || undefined, { day: 'numeric', month: 'numeric', year: 'numeric' })

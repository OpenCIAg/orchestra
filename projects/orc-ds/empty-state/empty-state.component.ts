...
export class EmptyStateComponent { readonly title = input('Nothing here yet'); readonly description = input('There is no content to show.'); readonly icon = input('∅'); readonly actionLabel = input(''); readonly action = output<void>(); }

...
export class DocsComponent implements AfterViewInit, OnDestroy {
  ...
  readonly ciagGroups: CiagLogoGroup[] = [
    {
      id: 'azul',
      label: 'CIAg — Versão azul',
      darkBg: false,
      formats: {
        svg: '/Logos%20CIAg/SVG/Logo%20Azul.svg',
        png: '/Logos%20CIAg/PNG/CIAG-Azul.png',
      },
    },
    {
      id: 'branco',
      ...
      darkBg: true,
      formats: {
        svg: '/Logos%20CIAg/SVG/Logo%20branca.svg',
        png: '/Logos%20CIAg/PNG/CIAG-Branco.png',
      },
    },
  ];
